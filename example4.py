...
box_red = Box(pr, pr + array([1.0, 1.0, 2.0]), color=red, ambient=0.2, diffuse=0.8)
box_green = Box(pg, pg + array([2.0, 1.0, 1.0]), color=green, ambient=0.2, diffuse=0.8)
box_blue = Box(pb, pb + array([3.0, 1.0, 0.5]), color=blue, ambient=0.2, diffuse=0.8)

plane = Plane(array([0.0, 0.0, 1.0]), 0.0, color=white, ambient=0.2, diffuse=0.8)

renderer([lightsource], [box_red, box_green, box_blue, plane], photo_exposure=0.0)
